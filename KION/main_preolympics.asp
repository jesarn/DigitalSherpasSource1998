<META HTTP-EQUIV="Refresh" CONTENT="100; URL=http://www.kiontv.com/main.asp">
...
<TABLE width=400 BORDER=0>
  ...
  <TR>
   ...
   <TABLE border=0>
     <tr><td align="CENTER" class=b>On KION Right Now:<br>
	 <B><!--#include file="onKIONnow.inc"--></B>
	 </td></tr>
	 <TR>
	 <TD class=a WIDTH=400>
         Find the links to the <a href="centralcoast/centralcoast.asp">latest</A> road closures and storm information in our Eye On the Central Coast section of the KION website.
         <BR><BR>
