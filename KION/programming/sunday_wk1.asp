...
<% showlink = "-DB=kionprogramming.fp3&-Format=programming_weekgrid.htm&date=" & week1startdate + 7  & "&-SortField=sort_order&-Max=50&-Find"
...
<br><br>
<A HREF="sunday_wk1.asp">Reload this page.</A>
<!-- db -->
