...
requestweekendFile = Server.MapPath ("/") & "\main\showtunes\smw\text\requestweekend.txt"
Set OutStream= FileObject.CreateTextFile (requestweekendFile, True, False)
requestweekendOut = Request.Form("requestweekend")
OutStream.WriteLine requestweekendOut
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title15File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests15.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist15File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta15.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title14File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests14.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist14File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta14.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title13File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests13.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist13File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta13.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title12File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests12.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist12File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta12.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title11File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests11.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist11File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta11.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title10File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests10.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist10File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta10.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title9File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests9.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist9File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta9.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title8File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests8.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist8File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta8.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title7File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests7.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist7File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta7.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title6File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests6.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist6File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta6.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title5File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests5.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist5File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta5.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title4File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests4.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist4File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta4.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title3File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests3.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist3File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta3.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title2File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests2.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist2File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta2.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
title1File = Server.MapPath ("/") & "\main\showtunes\smw\text\requests1.txt"
...
<%
Set FileObject = Server.CreateObject("Scripting.FileSystemObject")
artist1File = Server.MapPath ("/") & "\main\showtunes\smw\text\requesta1.txt"
