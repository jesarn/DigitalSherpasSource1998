...
<center><h3>Programming for Tuesday</h3></center>

<% showlink = "-DB=kcbaprogramming.fp3&-Format=programming.htm&date=" & week1startdate + 2  & "&-SortField=sort_order&-Max=50&-Find"
